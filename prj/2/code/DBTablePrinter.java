...
/****************************************************************************************
    *Title:Database Table Printer
    *Author:Torun,Hami
    *Date:2014
    *Code version:1.0
    *Availability:https://github.com/htorun/dbtableprinter
    *
 ***************************************************************************************/
  ...
  public static void printResultSet(ResultSet rs, int maxStringColWidth) {
    try {
      ...
      if (maxStringColWidth < 1) {
        System.err
            .println("DBTablePrinter Info: Invalid max. varchar column width. Using default!");
